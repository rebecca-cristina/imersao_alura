    ...
    public static void main(String[] args) throws Exception {
        ...
        for (double cor = 0; cor <= corClassificacao; cor++) {
            ...
            if (corClassificacao <= 10.0 && corClassificacao >= 9.7){
                System.out.print("\u001b[1m \u001b[38;2;255;255;255m \u001b[48;2;15;219;11mClassificação: " + filme.get("imDbRating") + "\u001b[0m \u001b[m");
                break;           
            
            } else if(corClassificacao < 9.7 && corClassificacao >= 9.5) {
                System.out.print("\u001b[1m \u001b[38;2;255;255;255m \u001b[48;2;20;219;11mClassificação: " + filme.get("imDbRating") + "\u001b[0m \u001b[m");
                break;
